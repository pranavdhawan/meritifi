    ...
    <section id="hero" className="w-[1440px] max-w-full mx-auto">
      <div className="flex gap-5 max-sm:flex-col-reverse">
        <div className="flex-1 pl-20 pt-[211px] max-sm:pt-8 max-sm:px-6">
          ...
          <p className="ds-body-1 text-[#868686] max-w-[641px] mt-4">Meritifi is for all those who want a little more than enough.</p>
        ...
        <div className="w-[478.28px] ml-[80px] rounded-b-[229.39px] overflow-hidden max-sm:ml-0 max-sm:self-center">
          <Image src="/assets/hero-cover.png" alt="Hero" width={478} height={718} className="object-cover" priority />
        </div>
      </div>
    </section>
  )
