export default function Landing() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* top tutors */}
      <section className="w-[1440px] max-w-full mx-auto" style={{ height: 670 }}>
        <h2 className="font-display text-[40px] leading-[1.2] text-center pt-[60px]">Our Best Teachers, Your Best Mentors</h2>
          ...
          {[
            ...
            <div key={tutor.name} className="w-[316px] h-[384px] rounded-[60px_60px_12px_12px] shadow-[2px_2px_4px_rgba(0,0,0,0.25)] bg-[#FFF3FA] relative">
              <div className="absolute left-[47px] -top-[28px] w-[221px] h-[196px] rounded-[60px] overflow-hidden bg-white">
                <img src="/assets/tutor-card-bg.png" alt="tutor" className="w-full h-full object-cover" />
              </div>
              ...
              <div className="absolute left-[36px] top-[345px] flex gap-3">
                <button className="w-[109px] h-[30px] rounded bg-white border border-[#FC4BC7] text-[#FF5CDC] text-[16px]">Chat</button>
                <button className="w-[109px] h-[30px] rounded bg-[#FF95D3] border border-[#E049AE] text-white text-[16px]">View</button>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* success stories */}
      <section className="w-[1440px] max-w-full mx-auto" style={{ height: 670 }}>
        <h2 className="font-display text-[40px] leading-[1.2] text-center pt-[60px]">When you Make Merit Yours</h2>
