  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-5">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <h1 className="ds-heading-1 text-gray-900">
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <Button
                  size="btn1"
                  className="bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-300 hover:from-yellow-500 hover:via-orange-500 hover:to-yellow-400 text-black border-2 border-yellow-400"
                >
                  Find a Teacher
                </Button>
                <Button
              ...
              <Button
                size="btn3"
                className="bg-gradient-to-r from-cyan-400 via-blue-400 to-cyan-300 hover:from-cyan-500 hover:via-blue-500 hover:to-cyan-400 text-white border-2 border-cyan-400"
              >
                Start a Chat
              </Button>
            </div>
            ...
            <div className="relative">
              ...
              <div
                className="absolute bottom-20 -right-10 w-36 h-36 bg-yellow-400 rounded-full shadow-lg flex items-center justify-center animate-float"
              ...
              <div
                className="absolute bottom-10 left-20 w-28 h-28 bg-purple-500 rounded-full shadow-lg flex items-center justify-center animate-float"
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-5">
          <h2 className="ds-heading-2 text-center text-gray-900 mb-16">
            How It Works
          </h2>
            ...
            <div className="bg-white/70 backdrop-blur-md rounded-2xl p-8 shadow-lg">
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="ds-subheading text-purple-600">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <h3 className="ds-subheading text-gray-900">
              ...
              <div className="space-y-6">
                ...
                <Button
                  size="btn2"
                  className="bg-gradient-to-r from-purple-500 via-blue-500 to-purple-400 hover:from-purple-600 hover:via-blue-600 hover:to-purple-500 text-white border-2 border-purple-500"
                >
                  Teacher Dashboard
                </Button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              ...
              {/* Name */}
              <h3 className="ds-subheading text-gray-900 mb-4">
                Ashish Chanchalani
              </h3>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="ds-body-3 text-gray-700">4.5</span>
                </div>
                <div className="w-px h-4 bg-gray-300"></div>
                <div className="flex items-center space-x-2">
                  <Users className="w-4 h-4 text-blue-500" />
                  <span className="ds-body-3 text-gray-700">Hybrid</span>
                </div>
                <div className="w-px h-4 bg-gray-300"></div>
                <div className="flex items-center space-x-2">
                  <MapPin className="w-4 h-4 text-red-500" />
                  <span className="ds-body-3 text-gray-700">South Delhi</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="space-y-1">
                  <p className="ds-body-3 text-gray-700">
                    Sub: Physics & Maths
                  </p>
                  <p className="ds-body-3 text-gray-700">Classes: 1st-12th</p>
                </div>
                <div className="w-px h-12 bg-gray-300"></div>
                <div className="space-y-1">
                  <p className="ds-body-3 text-gray-700">Exp: 7 Years</p>
                  <p className="ds-body-3 font-semibold text-green-600">
                    ₹ 20/min
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              ...
              {/* Name */}
              <h3 className="ds-subheading text-gray-900 mb-4">Priya Sharma</h3>

              {/* Stats */}
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2">
                  <Star className="w-4 h-4 text-yellow-500 fill-current" />
                  <span className="ds-body-3 text-gray-700">4.8</span>
                </div>
                <div className="w-px h-4 bg-gray-300"></div>
                <div className="flex items-center space-x-2">
                  <Users className="w-4 h-4 text-blue-500" />
                  <span className="ds-body-3 text-gray-700">Online</span>
                </div>
                <div className="w-px h-4 bg-gray-300"></div>
                <div className="flex items-center space-x-2">
                  <MapPin className="w-4 h-4 text-red-500" />
                  <span className="ds-body-3 text-gray-700">Mumbai</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="space-y-1">
                  ...
                  <p className="ds-body-3 text-gray-700">Classes: 9th-12th</p>
                </div>
                <div className="w-px h-12 bg-gray-300"></div>
                <div className="space-y-1">
                  <p className="ds-body-3 text-gray-700">Exp: 5 Years</p>
                  <p className="ds-body-3 font-semibold text-green-600">
                    ₹ 25/min
                  </p>
                </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              ...
              {/* Name */}
              <h3 className="ds-subheading text-gray-900 mb-4">Rahul Verma</h3>

              {/* Stats */}
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2">
                  <Star className="w-4 h-4 text-yellow-500 fill-current" />
                  <span className="ds-body-3 text-gray-700">4.6</span>
                </div>
                <div className="w-px h-4 bg-gray-300"></div>
                <div className="flex items-center space-x-2">
                  <Users className="w-4 h-4 text-blue-500" />
                  <span className="ds-body-3 text-gray-700">Offline</span>
                </div>
                <div className="w-px h-4 bg-gray-300"></div>
                <div className="flex items-center space-x-2">
                  <MapPin className="w-4 h-4 text-red-500" />
                  <span className="ds-body-3 text-gray-700">Bangalore</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="space-y-1">
                  ...
                  <p className="ds-body-3 text-gray-700">Classes: 6th-12th</p>
                </div>
                <div className="w-px h-12 bg-gray-300"></div>
                <div className="space-y-1">
                  <p className="ds-body-3 text-gray-700">Exp: 8 Years</p>
                  <p className="ds-body-3 font-semibold text-green-600">
                    ₹ 30/min
                  </p>
                </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="space-y-3">
                <span className="ds-body-3 text-purple-600 font-medium">
                  ARTICLE
                </span>
                <h3 className="ds-body-1 font-bold text-gray-900">
                  Offline or Online: What Works Best for Today&apos;s Learners?
                </h3>
                <p className="ds-body-3 text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="space-y-3">
                <span className="ds-body-3 text-orange-600 font-medium">
                  ARTICLE
                </span>
                <h3 className="ds-body-1 font-bold text-gray-900">
                ...
                <p className="ds-body-3 text-gray-600">
                  ...
                  reminders—here&apos;s how today&apos;s students are getting
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="space-y-3">
                <span className="ds-body-3 text-green-600 font-medium">
                  ARTICLE
                </span>
                <h3 className="ds-body-1 font-bold text-gray-900">
                ...
                <p className="ds-body-3 text-gray-600">
                  Flexibility is key, but the hybrid model might just be the
                  future of effective education.
                </p>
                <div className="flex items-center justify-between">
                  <span className="ds-body-3 text-green-600 font-medium">
                    Read more
        ...
        <div className="max-w-7xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <p className="ds-body-2 text-gray-700 mb-4">
                &quot;Headspace gives me a slice of the day that&apos;s just for
                me.&quot;
              </p>
              <div className="text-sm">
                <p className="ds-body-3 font-semibold text-gray-900">
                  Nadien, New Mexico
                </p>
                <p className="ds-body-3 text-gray-600">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <p className="ds-body-2 text-gray-700 mb-4">
                &quot;Your app brings so much peace and tolerance to our
                home.&quot;
              </p>
              <div className="text-sm">
                <p className="ds-body-3 font-semibold text-gray-900">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="space-y-6">
                ...
                <Button
                  size="lg"
                  className="w-full py-4 text-lg font-semibold bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-300 hover:from-yellow-500 hover:via-orange-500 hover:to-yellow-400 text-black border-2 border-yellow-400"
                >
                  Search Now
                </Button>
              </div>
            ...
            <div className="mt-8 bg-blue-50 rounded-2xl p-6 text-center">
              <h3 className="ds-subheading text-gray-900 mb-3">
                Keep Your Learning Streak Strong!
              </h3>
              <p className="ds-body-2 text-gray-700">
          ...
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300">
                Empowering students and teachers to achieve their full potential
                through innovative education solutions.
              </p>
            </div>
            ...
            {/* Follow Us */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold font-display">Follow Us</h3>
